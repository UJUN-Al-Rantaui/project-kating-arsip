                                            ...
                                            if($file != ""){
                                                ...
                                                if(in_array($eks, $ekstensi) == true){
                                                    if($ukuran < 2500000){
                                                        ...
                                                        $query = mysqli_query($config, "INSERT INTO tbl_surat_masuk(no_surat,asal_surat,tujuan_surat,perihal,tgl_surat,
                                                            tgl_diterima,file,keterangan,id_user)
                                                                VALUES('$no_surat','$asal_surat', $tujuan_surat,'$perihal','$tgl_surat',NOW(),'$nfile','$keterangan','$id_user')");
                                                ...
                                                $query = mysqli_query($config, "INSERT INTO tbl_surat_masuk(no_surat,asal_surat,tujuan_surat,perihal,tgl_surat,tgl_diterima,file,keterangan,id_user)
                                                    VALUES('$no_surat','$asal_surat', $tujuan_surat,'$perihal','$tgl_surat',NOW(),'','$keterangan','$id_user')");
