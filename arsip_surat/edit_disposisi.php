                        ...
                        <div class="input-field col s6">
                            ...
                            <div class="input-field col s11 right">
                                <select class="browser-default validate" name="tujuan" id="tujuan" required>
                                    ...
                                    <option value="4" <?php echo $row['tujuan'] == "4" ? "selected":"" ?>>PKM</option>
                                    <option value="5" <?php echo $row['tujuan'] == "5" ? "selected":"" ?>>PKA</option>
                                    <option value="6" <?php echo $row['tujuan'] == "6" ? "selected":"" ?>>P4GKA</option>
                                </select>
                            </div>
                                <?php
