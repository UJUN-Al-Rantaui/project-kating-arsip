                    ...
                    <div class="logo-side center blue-grey darken-3">
                        ...
                        while ($data = mysqli_fetch_array($query)) {
                            if (!empty($data['logo'])) {
                                ...
                                echo '<img class="logoside" src="./asset/img/uniska.png"/>';
                            }
                            if (!empty($data['nama'])) {
                                echo '<h5 class="smk-side">' . $data['nama'] . '</h5>';
                            } else {
                                echo '<h5 class="smk-side">Badan Kepegawaian dan Sumber Daya Alam</h5>';
                            }
                            if (!empty($data['alamat'])) {
                                echo '<p class="description-side">' . $data['alamat'] . '</p>';
                            } else {
                                echo '<p class="description-side">Jl. Menteri Empat, Kec. Martapura, Kabupaten Banjar, Kalimantan Selatan 70714</p>';
                            }
                        }
                        ?>
                    </div>
                            ...
                            <li>
                                ...
                                <div class="collapsible-body">
                                    <ul>
                                        ...
                                        <li style="display: none"><a href="?page=tsk">Surat Keluar</a></li>
                                    </ul>
                                </div>
                            </li>
                        </ul>
