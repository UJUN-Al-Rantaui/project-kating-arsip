    ...
    <div class="footer-copyright blue-grey darken-1 black-text">
        <div class="container" id="footer">
           <div class="cop" align="center">
				 <a href="https://sites.google.com/view/mtsalkhairaatboroko" target="_blank">
			</div>
        </div>
    </div>
</footer>
...
$(document).ready(function(){
    ...
    //jquery datepicker
    $('#tgl_surat,#batas_waktu,#dari_tanggal,#sampai_tanggal,#tanggal_mulai,#tanggal_selesai').pickadate({
        selectMonths: true,
        selectYears: 10,
        format: "yyyy-mm-dd"
    });
