                        ...
                        <div class="nav-wrapper blue-grey darken-1">
                            <ul class="left">
                                <li class="waves-effect waves-light"><a href="?page=<?php echo $page ?>&act=add" class="judul"><i
                                            class="material-icons">person</i> Edit Data Pegawai</a></li>
                            </ul>
                        </div>
                    </nav>
                </div>
            ...
            <div class="row jarak-form">
                ...
                <form class="col s12" method="POST" action="?page=<?php echo $page ?>&act=edit" enctype="multipart/form-data">
                    ...
                    <div class="input-field col s6">
                        ...
                        <input id="nama" type="text" class="validate" name="nama" value="<?php echo $pegawai->getNama() ?>"
                            required>
                        <?php
                    ...
                    <div class="input-field col s6">
                        ...
                        <input id="telepon" type="tel" class="validate" name="telepon" value="<?php echo $pegawai->getTelepon() ?>"
                            required>
                        <?php
                    ...
                    <div class="input-field col s6">
                        ...
                        <textarea id="alamat" class="materialize-textarea validate" name="alamat"
                            required><?php echo $pegawai->getAlamat() ?></textarea>
                        <?php
