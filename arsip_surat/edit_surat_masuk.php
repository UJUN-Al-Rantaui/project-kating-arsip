<?php
    ...
    if(empty($_SESSION['admin'])){
        ...
        if(isset($_REQUEST['submit'])){
            ...
            if($_REQUEST['no_surat'] == "" || $_REQUEST['asal_surat'] == "" || $_REQUEST['tujuan_surat'] == "" || $_REQUEST['perihal'] == ""
                ...
                if(!preg_match("/^[a-zA-Z0-9.\/ -]*$/", $no_surat)){
                    ...
                    if(!preg_match("/^[a-zA-Z0-9.,() \/ -]*$/", $asal_surat)){
                        ...
                        if(!preg_match("/^[4-6]*$/", $tujuan_surat)){
                            $_SESSION['tipeuser'] = 'Form Tipe User hanya boleh mengandung karakter angka 4 sampai 6';
                            echo '<script language="javascript">window.history.back();</script>';
                        } else {
                                ...
                                if(!preg_match("/^[0-9.-]*$/", $tgl_surat)){
                                    ...
                                    if(!preg_match("/^[a-zA-Z0-9.,()\/ -]*$/", $keterangan)){
                                        ...
                                        if($file != ""){
                                            ...
                                            if(in_array($eks, $ekstensi) == true){
                                                if($ukuran < 2300000){
                                                    ...
                                                    if(!empty($file)){
                                                        ...
                                                        $query = mysqli_query($config, "UPDATE tbl_surat_masuk SET no_surat='$no_surat',asal_surat='$asal_surat',tujuan_surat='$tujuan_surat',perihal='$perihal',tgl_surat='$tgl_surat',file='$nfile',keterangan='$keterangan',id_user='$id_user' WHERE id_surat='$id_surat'");
                                            ...
                                            $query = mysqli_query($config, "UPDATE tbl_surat_masuk SET no_surat='$no_surat',asal_surat='$asal_surat',tujuan_surat='$tujuan_surat',perihal='$perihal',tgl_surat='$tgl_surat',keterangan='$keterangan',id_user='$id_user' WHERE id_surat='$id_surat'");
        ...
        $query = mysqli_query($config, "SELECT id_surat, no_surat, asal_surat, tujuan_surat, perihal, tgl_surat, file, keterangan, id_user FROM tbl_surat_masuk WHERE id_surat='$id_surat'");
        list($id_surat, $no_surat, $asal_surat, $tujuan_surat, $perihal, $tgl_surat, $file, $keterangan, $id_user) = mysqli_fetch_array($query);
            ...
            <div class="row jarak-form">
                ...
                <form class="col s12" method="POST" action="?page=tsm&act=edit" enctype="multipart/form-data">
                    ...
                    <!-- Row in form START -->
                        ...
                        <div class="input-field col s6">
                            <i class="material-icons prefix md-prefix">supervisor_account</i><label>Pilih Tujuan Surat</label><br/>
                            <div class="input-field col s11 right">
                                <select class="browser-default validate" name="tujuan_surat" id="tujuan_surat" required>
                                    <option value="">Tujuan Surat</option>
                                    <option value="4">PKM</option>
                                    <option value="5">PKA</option>
                                    <option value="6">P4GKA</option>
                                </select>
                            </div>
                                <?php
